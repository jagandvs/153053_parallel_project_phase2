package com.capgemini.mypaymentapp.pl;
...
import com.capgemini.mypaymentapp.beans.Wallet;
import com.capgemini.mypaymentapp.exception.InsufficientBalanceException;
import com.capgemini.mypaymentapp.exception.InvalidInputException;
import com.capgemini.mypaymentapp.service.WalletService;
import com.capgemini.mypaymentapp.service.WalletServiceImpl;
...
public class Client {
	...
	public void showBalance()
	{
		...
		try 
		{
			...
			System.out.println("Your balance for the account liked with mobile number : "+mobileNo2+" is "+customer.getWallet().getBalance());
		}
